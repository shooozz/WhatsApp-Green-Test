...
export const sendMessageRequest = async (idInstance: string, apiTokenInstance: string, phoneNumber: string, message: string) => {
...
export const fetchMessagesRequest = async (idInstance: string, apiTokenInstance: string, phoneNumber: string) => {
