...
export const ChatWidget = () => {
    ...
    const MemoizedChatHistory = useMemo(() => <ChatHistory chatHistory={chatHistory} />, [chatHistory])

    const { sendMessage } = useSendMessage(idInstance, apiTokenInstance, phoneNumber, message, setMessage, setChatHistory)
    const { fetchMessages } = useFetchMessages(idInstance, apiTokenInstance, phoneNumber, setChatHistory)
    ...
    return (
        <div className='p-4'>
            ...
            <div className='flex gap-2'>
                <Input className='flex-grow' placeholder='Type your message' value={message} onChange={e => setMessage(e.target.value)} />
